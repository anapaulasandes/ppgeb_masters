...
{\bfseries{\maiusc{\large Lista de Nomenclaturas e Abreviações}} } %não consigo usar por nada isso!! 
\end{center}
...
%\include{fundamentacao_teorica/chap_series_temporais.tex}

\include{fundamentacao_teorica/chap_sincronization.tex}

%\include{fundamentacao_teorica/chap_acesso_a_datasets.tex}

\include{fundamentacao_teorica/chap_uso_datasets_em_aprendizado_maquina.tex}

\include{fundamentacao_teorica/chap_materiais_e_métodos.tex}


\include{fundamentacao_teorica/resultados_e_discussões.tex}
...
\section{Dados do Mindwave Mobile II}
\begin{quadro}
    ...
    \begin{tabular}{|l|l|l|}
    \hline
        \hfill Feature\hfill\hspace{1mm} & \hfill Definição\hfill\hspace{1mm} & \hfill Tipo de Dado\hfill\hspace{1mm}\\
        \hline Attention &  \hspace{-06pt}\begin{tabular}{l}Métrica definida pelo eSense\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline Meditation & \hspace{-06pt}\begin{tabular}{l}Métrica definida pelo eSense\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline rawValue & \hspace{-06pt}\begin{tabular}{l}Amostra de onda sem tratamento; \\ necessita de operação para devolver valor completo\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (-32768-32767)\end{tabular}\\
        \hline delta & \hspace{-06pt}\begin{tabular}{l}Poder de Banda Relativo de onda após a remoção de artefatos\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline tetha & \hspace{-06pt}\begin{tabular}{l}Poder de Banda Relativo de onda após a remoção de artefatos\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline lowAlpha & \hspace{-06pt}\begin{tabular}{l}Poder de Banda Relativo de onda após a remoção de artefatos\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline highAlpha & \hspace{-06pt}\begin{tabular}{l}Poder de Banda Relativo de onda após a remoção de artefatos\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline lowBeta & \hspace{-06pt}\begin{tabular}{l}Poder de Banda Relativo de onda após a remoção de artefatos\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline highBeta & \hspace{-06pt}\begin{tabular}{l}Poder de Banda Relativo de onda após a remoção de artefatos\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-100)\end{tabular}\\
        \hline poorSignal & \hspace{-06pt}\begin{tabular}{l}Poder de Banda Relativo de onda após a remoção de artefatos\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-200)\end{tabular}\\
        \hline blinkStrength & \hspace{-06pt}\begin{tabular}{l}Sem unidades. Representa força relativa de uma piscada.\end{tabular} &  \hspace{-06pt}\begin{tabular}{l}int (0-255)\end{tabular}\\
    \hline
    \end{tabular}
    \scalefont{1.4184}
    \end{center}
