...
desenvolvedor do software orange para classificação com cross-validação (figura 9.5). 
 ...
 \begin{figure}[!h]
    \centering
    \includegraphics[width=150mm]{Screen Shot 2022-09-05 at 19.25.37.png}
...
e Support Vector Machine (SVM). (Figura 9.6). 
 ...
 \begin{figure}[!h]
    \centering
    \includegraphics[width=100mm]{Screen Shot 2022-08-31 at 22.30.08.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=100mm]{4-1.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=100mm]{0_tG-IWcxL1jg7RkT0.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=80mm]{SVM_margin.png}
    \caption{SVM Linear}
\end{figure}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=110mm]{curvaROC.jpeg}
    \caption{SVM Linear}
\end{figure}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=100mm]{matrizConfusao-600x381.png}
